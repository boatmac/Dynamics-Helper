...
AGENTS.md § 4.2 (Timeouts) and § 4.9 (Persistence) rewritten to pin the new contracts as critical rules. DEVELOPER_GUIDE.md and USER_GUIDE.md brought up to date. Full design spec: `docs/specs/2026-06-03-analysis-result-persistence-design.md`.
