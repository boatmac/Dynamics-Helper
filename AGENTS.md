...
* **Logging boundary:** Never log prompt content or prompt-source paths. This includes instruction content and Custom User Prompt content. Safe mode, classified error code, and a short fingerprint prefix are sufficient diagnostics.
